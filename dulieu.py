# giả sử list khách hàng chỉ có 5 thành viên trong nhóm
...
hanmuc = [10000000, 15000000, 20000000, 30000000, 40000000]
# giả sử ngân hàng có sẵn 20 triệu
sodunganhang = [20000000]
